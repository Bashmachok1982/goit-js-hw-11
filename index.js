import{a as d,S as g,i as c}from"./assets/vendor-Cq7ZUixy.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const h="https://pixabay.com/api/",m="54231324-92d51f5acf633d69a742454d8";function C(o){const i={key:m,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:12,page:1};return d.get(h,{params:i}).then(t=>t.data).catch(t=>{throw t.response?new Error(`Pixabay error: ${t.response.status} - ${t.response.data}`):t.request?new Error("No response from Pixabay. Check internet connection."):new Error(`Request setup error: ${t.message}`)})}const n=document.querySelector(".gallery"),l=document.querySelector(".loader"),y=new g(".gallery a",{captionsData:"alt",captionDelay:250});function L(o){if(!o||o.length===0||!n)return;const i=o.map(({webformatURL:t,largeImageURL:a,tags:e="Image",likes:r,views:s,comments:u,downloads:f})=>`
    ...
    `).join("");n.insertAdjacentHTML("beforeend",i),y.refresh()}function w(){n&&(n.innerHTML="")}function b(){l&&l.classList.add("is-visible")}function v(){l&&l.classList.remove("is-visible")}const p=document.querySelector(".form");p.addEventListener("submit",o=>{o.preventDefault();const i=o.target.elements.searchQuery.value.trim();if(!i){c.warning({message:"Please enter a search query!",position:"topRight",timeout:3e3});return}w(),b(),C(i).then(t=>{if(t.hits.length===0){c.error({message:`
          ...
          `,position:"topRight",icon:!1,close:!0,timeout:5e3});return}L(t.hits)}).catch(t=>{c.error({message:"Something went wrong. Please try again later.",position:"topRight",timeout:5e3})}).finally(()=>{v(),p.reset()})});
